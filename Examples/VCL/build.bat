...
set PROJECT=Chart4DDemoVcl.dpr
...
%DCC32% -$O- -$W+ --no-config -B -Q -TX.exe ^
  ...
  -DDEBUG ^
  -E%OUTPUT_DIR% ^
  -I"%BDS%\lib\Win32\debug";..\..\Source;..\Common;..\..\Source\VCL;"%BDS%\lib\Win32\release";"%BDSUSERDIR%\Imports";"%BDSUSERDIR%\Imports\Win32";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp";"%BDS%\include" ^
  -LE"%BDSCOMMONDIR%\Bpl" ^
  -LN"%BDSCOMMONDIR%\Dcp" ^
  -NU%OUTPUT_DIR% ^
  -NSSystem.Win;Data.Win;Datasnap.Win;Web.Win;Soap.Win;Xml.Win;Bde;System;Xml;Data;Datasnap;Web;Soap;Winapi; ^
  -O..\..\Source;..\Common;..\..\Source\VCL;"%BDS%\lib\Win32\release";"%BDSUSERDIR%\Imports";"%BDSUSERDIR%\Imports\Win32";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp";"%BDS%\include" ^
  -R..\..\Source;..\Common;..\..\Source\VCL;"%BDS%\lib\Win32\release";"%BDSUSERDIR%\Imports";"%BDSUSERDIR%\Imports\Win32";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp";"%BDS%\include" ^
  -U"%BDS%\lib\Win32\debug";..\..\Source;..\Common;..\..\Source\VCL;"%BDS%\lib\Win32\release";"%BDSUSERDIR%\Imports";"%BDSUSERDIR%\Imports\Win32";"%BDS%\Imports";"%BDSCOMMONDIR%\Dcp";"%BDS%\include" ^
  -V ^
  -VN ^
  -NB"%BDSCOMMONDIR%\Dcp" ^
...
echo Executable: %OUTPUT_DIR%\Chart4DDemoVcl.exe
